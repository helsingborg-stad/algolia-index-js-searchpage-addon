import { algoliaDataTransform, algoliaFacetTransform, algoliaParamTransform } from './algolia-adapter';
...
describe('Algolia', () => {
	const document: WPPost = {
		...
		embedding: [
			-0.023418115451931953, -0.011796395294368267, 0.0005083775031380355, 0.03602966293692589, -0.005048112012445927,
			-0.0018282666569575667,
		],
		id: '5283',
		...
		permalink: 'https://foretagare.helsingborg.se/nyheter/intervju-med-alejandro-bustos/',
		...
		post_title: 'Intervju med Alejandro Bustos &ndash; fr&aring;n Colombia till Helsingborg',
		post_type: 'nyheter',
		post_type_name: 'Nyheter',
		tags: ['Företagare'],
		thumbnail: 'https://media.helsingborg.se/uploads/networks/1/sites/2/2024/05/img_3906-scaled-480x270.webp',
	...
	it('Transform full Algolia document to generic format', async () => {
		...
		expect(data.title).toEqual('Intervju med Alejandro Bustos &ndash; fr&aring;n Colombia till Helsingborg');
		...
		expect(data.url).toEqual('https://foretagare.helsingborg.se/nyheter/intervju-med-alejandro-bustos/');
	});
